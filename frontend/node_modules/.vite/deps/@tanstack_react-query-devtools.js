...
import { I as onlineManager, at as useQueryClient } from "./modern-CmpjUD3-.js";
import { B as render, F as mergeProps, N as lazy, W as setupStyleSheet, m as createComponent, x as createSignal } from "./utils-CESniQp_-D23oyiCl.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./DevtoolsComponent-CFsAhafd-DsLJHqiI.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./DevtoolsPanelComponent-B9zkHqmD-DlTR6fNl.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
...
function ReactQueryDevtoolsPanel$1(props) {
	const queryClient = useQueryClient(props.client);
	const ref = import_react.useRef(null);
...
var ReactQueryDevtools = ReactQueryDevtools$1;
var ReactQueryDevtoolsPanel = ReactQueryDevtoolsPanel$1;
//#endregion
